# Generated by Django 3.2.8 on 2021-11-02 03:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('followers', models.ManyToManyField(blank=True, related_name='followers', to='socialDistribution.Author')),
        ...
        migrations.AddField(
            model_name='post',
            name='likes',
            field=models.ManyToManyField(blank=True, related_name='liked_post', to='socialDistribution.LocalAuthor'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('pub_date', models.DateTimeField()),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='socialDistribution.post')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='socialDistribution.localauthor')),
            ],
        ),
        migrations.CreateModel(
            name='Inbox',
