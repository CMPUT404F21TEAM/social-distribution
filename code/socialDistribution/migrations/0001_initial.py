# Generated by Django 3.2.8 on 2021-11-30 01:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField()),
                ('displayName', models.CharField(default='Anonymous User', max_length=50)),
                ('githubUrl', models.CharField(max_length=200, null=True)),
                ('profileImageUrl', models.CharField(max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.URLField(default='', max_length=2048)),
                ('origin', models.URLField(default='', max_length=2048)),
                ('public_id', models.URLField()),
                ('description', models.CharField(max_length=100)),
                ('content_type', models.CharField(choices=[('MD', 'text/markdown'), ('PL', 'text/plain'), ('B64', 'application/base64'), ('PNG', 'image/png;base64'), ('JPEG', 'image/jpeg;base64')], default='PL', max_length=50)),
                ('content', models.BinaryField(blank=True, max_length=4096, null=True)),
                ('published', models.DateTimeField(default=django.utils.timezone.now)),
                ('visibility', models.CharField(choices=[('PB', 'PUBLIC'), ('FR', 'FRIEND'), ('PR', 'PRIVATE')], default='PB', max_length=50)),
