...
urlpatterns = [
    ...
    path('author/<author_id>/followers/<path:foreign_author_id>', FollowersSingleView.as_view(), name='followers-single'),
    ...
    path('author/<author_id>/posts/<post_id>/comments/', PostCommentsView.as_view(), name='post_comments'),
    path('author/<author_id>/posts/<post_id>/comments/<comment_id>', PostCommentsSingleView.as_view(), name='post_comments_single'),
    path('author/<author_id>/posts/<post_id>/comments/<comment_id>/', PostCommentsSingleView.as_view(), name='post_comments_single'),
